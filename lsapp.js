...
/* ADVANCED_OPTION_GROUPS entfernt — keine Profi-Einstellungen mehr, Simulation läuft nur über Modell + Winkel + Foto. */
...
function getAdvancedOptionDefs(){
 /* PROFI-EINSTELLUNGEN komplett entfernt — jeder Service/jedes Modell definiert sein eigenes
    Verhalten (Intensität, Ton, Dichte, Platzierung) über die Service-Beschreibung selbst.
    Ablauf: Modell wählen → Winkel wählen → Foto hochladen → Simulation. */
 return [];
}
